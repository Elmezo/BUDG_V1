...
@WebServlet("/api/bulk/role/status/*")
public class RoleBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(RoleBulkStatusServlet.class);
