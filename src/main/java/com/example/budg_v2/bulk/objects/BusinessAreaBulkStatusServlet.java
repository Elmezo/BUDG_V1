...
@WebServlet("/api/bulk/businessarea/status/*")
public class BusinessAreaBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(BusinessAreaBulkStatusServlet.class);
