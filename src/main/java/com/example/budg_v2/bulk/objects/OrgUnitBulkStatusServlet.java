...
@WebServlet("/api/bulk/orgunit/status/*")
public class OrgUnitBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(OrgUnitBulkStatusServlet.class);
