...
@WebServlet("/api/bulk/system/report/*")
public class SystemBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(SystemBulkReportServlet.class);
