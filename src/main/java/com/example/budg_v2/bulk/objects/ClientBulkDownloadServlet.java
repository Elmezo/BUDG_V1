...
@WebServlet("/api/bulk/client/download/*")
public class ClientBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(ClientBulkDownloadServlet.class);
