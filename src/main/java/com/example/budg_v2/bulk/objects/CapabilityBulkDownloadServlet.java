...
@WebServlet("/api/bulk/capability/download/*")
public class CapabilityBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(CapabilityBulkDownloadServlet.class);
