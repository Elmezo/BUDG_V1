...
@WebServlet("/api/bulk/glossary/report/*")
public class GlossaryBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(GlossaryBulkReportServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        logger.info("Fetching Glossary report for job ID: {}", jobId);
        try {
            ...
            if (resourceFile != null) {
                ...
                fileInfo.addProperty("download_url", "/api/bulk/glossary/download/" + jobId);
