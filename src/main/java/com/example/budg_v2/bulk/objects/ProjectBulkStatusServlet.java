...
/**
 * Servlet to provide job status for Project bulk upload polling.
 ...
 */
@WebServlet("/api/bulk/project/status/*")
public class ProjectBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(ProjectBulkStatusServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.debug("Returned status for project bulk job {}", jobId);
