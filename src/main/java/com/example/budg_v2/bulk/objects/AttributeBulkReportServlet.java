...
@WebServlet("/api/bulk/attribute/report/*")
public class AttributeBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(AttributeBulkReportServlet.class);
