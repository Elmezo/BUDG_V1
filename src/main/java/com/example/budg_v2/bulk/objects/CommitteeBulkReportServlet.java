...
@WebServlet("/api/bulk/committee/report/*")
public class CommitteeBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(CommitteeBulkReportServlet.class);
