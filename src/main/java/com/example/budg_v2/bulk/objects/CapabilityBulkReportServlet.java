...
@WebServlet("/api/bulk/capability/report/*")
public class CapabilityBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(CapabilityBulkReportServlet.class);
    ...
    private JsonObject getJobReport(int jobId) throws SQLException {
        ...
        try (Connection conn = com.example.budg_v2.database.DatabaseConnection.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                report.add("report_items", items); // Also include report_items for frontend compatibility
