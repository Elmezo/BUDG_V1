...
@WebServlet("/api/bulk/product/download/*")
public class ProductBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(ProductBulkDownloadServlet.class);
