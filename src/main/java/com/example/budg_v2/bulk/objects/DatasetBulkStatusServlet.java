...
@WebServlet("/api/bulk/dataset/status/*")
public class DatasetBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(DatasetBulkStatusServlet.class);
