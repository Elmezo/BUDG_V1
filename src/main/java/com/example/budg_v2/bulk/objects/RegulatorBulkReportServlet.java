...
@WebServlet("/api/bulk/regulator/report/*")
public class RegulatorBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(RegulatorBulkReportServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (resourceFile != null) {
                ...
                fileInfo.addProperty("download_url", "/api/bulk/regulator/download/" + jobId);
