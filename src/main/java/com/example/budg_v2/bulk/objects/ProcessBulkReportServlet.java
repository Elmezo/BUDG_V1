...
@WebServlet("/api/bulk/process/report/*")
public class ProcessBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(ProcessBulkReportServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        logger.info("Fetching Process report for job ID: {}", jobId);
        try {
            ...
            if (resourceFile != null) {
                ...
                fileInfo.addProperty("download_url", "/api/bulk/process/download/" + jobId);
