...
@WebServlet("/api/bulk/orgunit/report/*")
public class OrgUnitBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(OrgUnitBulkReportServlet.class);
