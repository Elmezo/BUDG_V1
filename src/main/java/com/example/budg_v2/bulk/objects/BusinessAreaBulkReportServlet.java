...
@WebServlet("/api/bulk/businessarea/report/*")
public class BusinessAreaBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(BusinessAreaBulkReportServlet.class);
