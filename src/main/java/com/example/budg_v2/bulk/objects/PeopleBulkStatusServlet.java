...
@WebServlet("/api/bulk/people/status/*")
public class PeopleBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(PeopleBulkStatusServlet.class);
