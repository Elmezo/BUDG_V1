...
@WebServlet("/api/bulk/interface/download/*")
public class InterfaceBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(InterfaceBulkDownloadServlet.class);
