...
@WebServlet("/api/bulk/interface/status/*")
public class InterfaceBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(InterfaceBulkStatusServlet.class);
