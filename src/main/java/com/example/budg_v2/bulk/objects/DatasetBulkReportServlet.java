...
@WebServlet("/api/bulk/dataset/report/*")
public class DatasetBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(DatasetBulkReportServlet.class);
