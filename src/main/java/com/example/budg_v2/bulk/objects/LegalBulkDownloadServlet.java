...
@WebServlet("/api/bulk/legal/download/*")
public class LegalBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(LegalBulkDownloadServlet.class);
