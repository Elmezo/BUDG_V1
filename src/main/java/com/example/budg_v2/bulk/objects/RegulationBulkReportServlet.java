...
@WebServlet("/api/bulk/regulation/report/*")
public class RegulationBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(RegulationBulkReportServlet.class);
