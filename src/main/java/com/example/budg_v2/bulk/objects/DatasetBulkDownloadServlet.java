...
@WebServlet("/api/bulk/dataset/download/*")
public class DatasetBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(DatasetBulkDownloadServlet.class);
