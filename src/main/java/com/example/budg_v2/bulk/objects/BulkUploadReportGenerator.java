...
/**
 * Generator for Excel reports for bulk upload operations (INSERT, UPDATE, DELETE)
 * Creates formatted Excel files with colored rows based on success/failure status
 */
public class BulkUploadReportGenerator {
    
    private static final Logger logger = LoggerFactory.getLogger(BulkUploadReportGenerator.class);
    
    /**
     * Report row data structure for general bulk upload operations
     */
    public static class ReportRow {
        ...
        public ReportRow(int rowNumber, String objectId, String objectName, String operation, 
                        String status, String errorMessages, String warningMessages, String actionTaken) {
    ...
    public byte[] generateReport(List<ReportRow> reportRows, String entityName, int jobId) throws IOException {
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
            XSSFSheet sheet = workbook.createSheet("Bulk Upload Report");
            ...
            titleCell.setCellValue("Bulk Upload Report - " + entityName);
            ...
            String[] headers = {"Row Number", "Object ID", "Object Name", "Operation", 
                               "Status", "Error Messages", "Warning Messages", "Action Taken"};
            ...
            for (ReportRow reportRow : reportRows) {
                ...
                cell1.setCellValue(reportRow.getObjectId() != null ? reportRow.getObjectId() : "");
                ...
                cell3.setCellValue(reportRow.getOperation() != null ? reportRow.getOperation() : "");
                cell3.setCellStyle(rowStyle);
                
                // Status
                Cell cell4 = row.createCell(4);
                cell4.setCellValue(reportRow.getStatus());
                cell4.setCellStyle(rowStyle);
                
                // Error Messages
                Cell cell5 = row.createCell(5);
                cell5.setCellValue(reportRow.getErrorMessages() != null ? reportRow.getErrorMessages() : "");
                cell5.setCellStyle(rowStyle);
                
                // Warning Messages
                Cell cell6 = row.createCell(6);
                cell6.setCellValue(reportRow.getWarningMessages() != null ? reportRow.getWarningMessages() : "");
                cell6.setCellStyle(rowStyle);
                
                // Action Taken
                Cell cell7 = row.createCell(7);
                cell7.setCellValue(reportRow.getActionTaken() != null ? reportRow.getActionTaken() : "");
