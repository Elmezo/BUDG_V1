...
@WebServlet("/api/bulk/regulator/download/*")
public class RegulatorBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(RegulatorBulkDownloadServlet.class);
