...
@WebServlet("/api/bulk/system/status/*")
public class SystemBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(SystemBulkStatusServlet.class);
