...
@WebServlet("/api/bulk/attribute/status/*")
public class AttributeBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(AttributeBulkStatusServlet.class);
