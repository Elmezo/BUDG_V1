...
@WebServlet("/api/bulk/regulatorytheme/report/*")
public class RegulatoryThemeBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(RegulatoryThemeBulkReportServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (resourceFile != null) {
                ...
                fileInfo.addProperty("download_url", "/api/bulk/regulatorytheme/download/" + jobId);
