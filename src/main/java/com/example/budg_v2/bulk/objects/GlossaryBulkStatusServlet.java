...
@WebServlet("/api/bulk/glossary/status/*")
public class GlossaryBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(GlossaryBulkStatusServlet.class);
