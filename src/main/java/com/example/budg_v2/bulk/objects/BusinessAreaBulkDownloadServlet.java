...
@WebServlet("/api/bulk/businessarea/download/*")
public class BusinessAreaBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(BusinessAreaBulkDownloadServlet.class);
