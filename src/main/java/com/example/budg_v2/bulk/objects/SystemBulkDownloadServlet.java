...
@WebServlet("/api/bulk/system/download/*")
public class SystemBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(SystemBulkDownloadServlet.class);
