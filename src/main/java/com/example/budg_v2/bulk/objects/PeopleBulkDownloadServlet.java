...
@WebServlet("/api/bulk/people/download/*")
public class PeopleBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(PeopleBulkDownloadServlet.class);
