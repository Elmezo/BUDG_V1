...
@WebServlet("/api/bulk/attribute/download/*")
public class AttributeBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(AttributeBulkDownloadServlet.class);
