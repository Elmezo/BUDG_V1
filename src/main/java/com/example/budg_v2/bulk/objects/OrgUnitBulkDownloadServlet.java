...
@WebServlet("/api/bulk/orgunit/download/*")
public class OrgUnitBulkDownloadServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(OrgUnitBulkDownloadServlet.class);
