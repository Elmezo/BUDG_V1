...
@WebServlet("/api/bulk/project/report/*")
public class ProjectBulkReportServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(ProjectBulkReportServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        logger.info("Fetching Project report for job ID: {}", jobId);
        try {
            ...
            if (resourceFile != null) {
                ...
                fileInfo.addProperty("download_url", "/api/bulk/project/download/" + jobId);
