...
@WebServlet("/api/bulk/legal/status/*")
public class LegalBulkStatusServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(LegalBulkStatusServlet.class);
