/**
 * Document Components Initialization for Process Edit Page
...
(function () {
    ...
    function initializeDocumentComponents() {
        ...
        if (!processId || isNaN(processId)) {
            console.error('Invalid process ID, cannot initialize document components');
            return;
        }

        console.log('Initializing document components for process ID:', processId);
    ...
    window.initProcessDocuments = initializeDocumentComponents;
})();
